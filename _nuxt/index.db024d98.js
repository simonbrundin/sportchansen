import{_ as y}from"./nuxt-link.f205c2a6.js";import{o as a,h as c,q as h,s as x,j as s,F as v,u,b as l,H as k,f as $,J as w,K as B,L as b,t as p,c as C,i as M}from"./entry.08c43bce.js";import{_ as g}from"./_plugin-vue_export-helper.c27b6911.js";import{g as q}from"./index.20f5cc3e.js";const D=""+new URL("default-user.8da67953.png",import.meta.url).href,E={},L={class:"flex justify-between items-center"},S=s("div",{class:"text-2xl font-extrabold"},"Välkommen!",-1);function U(n,e){const o=y;return a(),c("div",L,[S,h(o,{to:"/auth/profile"},{default:x(()=>[s("img",{src:D,width:48,quality:80,class:v({"bg-red-500":("nhost"in n?n.nhost:u(l)).auth.getUser()===null})},null,2)]),_:1})])}const A=g(E,[["render",U]]);async function N(n){const e=q`
